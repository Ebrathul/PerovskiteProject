...
# modified uses list of NN
def create_supervised_trainer_modified(model, optimizer, loss_fn, std=1,
    ...
    # # to use in main programm for working list of models with different parameters
...
def create_supervised_evaluator_modified(model, metrics={}, std=1,
                                device=None, non_blocking=False,
                                prepare_batch=prepare_batch,
